import sys, os, traceback, torch, json
from pathlib import Path
from transformers import Qwen2_5_VLForConditionalGeneration, AutoProcessor
from peft import PeftModel, LoraConfig

# Falls back to the Cloud Build /workspace paths (cloudbuild-merge.yaml) when
# the env vars aren't set, so this still works unchanged in that pipeline.
ADAPTER_DIR = os.environ.get("ADAPTER_DIR", "/workspace/checkpoint")
OUTPUT_DIR = os.environ.get("OUTPUT_DIR", "/workspace/merged-model")
